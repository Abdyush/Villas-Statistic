...
def separate_butler(cmt, other_comments):
    all_butlers = ['Черноштан', 'Царенков', 'Булгаков', 'Потапов', 'Доронин', 'Мантуров', 'Онищук', 'Мартынов', 'Саетов', 'Волгузов', 
    'Солодаев', 'Диденко', 'Календжян', 'Буркеев', 'Люфт', 'Карманов', 'Нечипуренко', 'Салединов', 'Тараев', 'Абдюшев', 'Марченко', 
    'Тлашадзе', 'Соловьев', 'Дейнекин', 'Лесников', 'Гончар', 'Федоренко']
    
    present_butlers = ['Черноштан', 'Булгаков', 'Онищук', 'Волгузов', 'Солодаев', 'Диденко', 'Люфт', 'Нечипуренко', 'Тараев', 'Абдюшев', 
    'Гончар', 'Федоренко', 'Марченко']
